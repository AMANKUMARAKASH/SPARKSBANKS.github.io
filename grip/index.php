...
<html lang="en">
<head>
   <title>AMAN BANKS - YOUR MONEY IS SAFE WITH US</title>
   <meta charset="utf-8">
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">aman banks  </a>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/bank.jfif" alt="Easy Transfer" width="1100" height="500">
      <div class="carousel-caption">
    <h3>Easy Money Transfer</h3>
    </div>
    </div>
    <div class="carousel-item">
      <img src="images/banks.jfif" alt="Quick Deposit" width="1100" height="500">
...
<div  class="col-lg-6 col-md-6 col-12">
      ...
      <div  class="col-lg-6 col-md-6 col-12">
      <h1>Aman Bank</h1>
      <p1> Aman Bank is a part of AMAN foundation. It is one of Znations's leading private banks and was among the first to receive approval from the Central bank of Znation (CBZ) to set up a private sector bank in 992 ZY.
          Today, AMAN Bank has a banking network of 5,608 branches and 16,087 ATM's in 2,902 cities/towns. AMAN Bank offers a diverse range of financial products and banking services to customers through a growing branch and ATM network and digital channels such as Netbanking, Phonebanking and MobileBanking.
...
<footer class="text-center mt-2 py-5">
        <p>&copy 2021  <b>AMAN KUMAR</b> </br>Chairman,  AMAN BANKS</p>
      </footer>
